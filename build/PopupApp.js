...
/***/ function(module, exports, __webpack_require__) {
	...
	var _reduxSaga = __webpack_require__(253);

	var _reduxSaga2 = _interopRequireDefault(_reduxSaga);

	var _Popup = __webpack_require__(727);

	var _Popup2 = _interopRequireDefault(_Popup);

	var _Popup3 = __webpack_require__(728);

	var _Popup4 = _interopRequireDefault(_Popup3);

	var _popupSagas = __webpack_require__(732);
	...
	var _blockList = __webpack_require__(267);
...
/***/ function(module, exports, __webpack_require__) {
	...
	function reducer() {
	  var state = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : { sites: [], message: '', timer: null };
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _possibleConstructorReturn2 = __webpack_require__(433);

	var _possibleConstructorReturn3 = _interopRequireDefault(_possibleConstructorReturn2);

	var _inherits2 = __webpack_require__(434);
	...
	var _thoughtcrime = __webpack_require__(442);

	var _thoughtcrime2 = _interopRequireDefault(_thoughtcrime);

	var _common = __webpack_require__(496);

	var _popup = __webpack_require__(729);

	var _Timer = __webpack_require__(730);

	var _Timer2 = _interopRequireDefault(_Timer);

	var _PopupInputBar = __webpack_require__(731);

	var _PopupInputBar2 = _interopRequireDefault(_PopupInputBar);
	...
	var PopupApp = function (_React$Component) {
	  ...
	  (0, _createClass3.default)(PopupApp, [{
	    ...
	    value: function render() {
	      ...
	      if (timer) {
	        timerComponent = _react2.default.createElement(_Timer2.default, timer);
	      } else {
	        timerComponent = '';
	      }
	      ...
	      }, void 0, 'Options'), (0, _jsx3.default)('button', {
	        type: 'button',
	        className: 'btn btn-default pull-right',
	...
	exports.default = (0, _reactRedux.connect)(function (state) {
	  ...
	  return {
	    addFilter: function addFilter(filter, action, type) {
	      return dispatch((0, _common.addFilter)(filter, action, type));
	    },
	    getTimer: function getTimer() {
	      return dispatch((0, _popup.getTimer)());
	    },
	    editDomainModal: function editDomainModal(domain) {
	      return dispatch((0, _popup.editDomainModal)(domain));
	    }
	  };
		})(PopupApp);
...
/***/ function(module, exports) {
	...
	exports.editDomainModal = editDomainModal;
	function getTimer() {
	  return {
	    type: 'GET_TIMER'
	  };
	}
	function editDomainModal(domain) {
	  return {
...
/***/ function(module, exports, __webpack_require__) {
	...
	var Timer = function (_React$Component) {
	  ...
	  function Timer(props) {
	    ...
	    var limitSeconds = props.currentLimit ? props.currentLimit - props.seconds : undefined;
	    _this.state = {
	  ...
	  (0, _createClass3.default)(Timer, [{
	    ...
	    value: function render() {
	      var _state = this.state,
	          ...
	          limitSeconds = _state.limitSeconds;

	      var spanTimer = void 0;
	      var spanStyle = {};
	      if (limitSeconds) {
	        spanTimer = _moment2.default.duration(limitSeconds - seconds, 'seconds').format('h:mm:ss', { trim: false });
	        spanStyle.color = 'red';
	      } else {
	        spanTimer = _moment2.default.duration(seconds, 'seconds').format('h:mm:ss', { trim: false });
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var InputBar = function (_React$Component) {
	  ...
	  (0, _createClass3.default)(InputBar, [{
	    ...
	    key: 'toggleACL',
	    value: function toggleACL(e) {
	      var value = e.target.value;
	      var handleTypeChange = this.props.handleTypeChange;
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _regenerator = __webpack_require__(710);
	...
	var _effects = __webpack_require__(713);

	var _sagasDB = __webpack_require__(714);

	var _reduxSaga = __webpack_require__(253);

	function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

	var _marked = [editDomain, getTimer, getTimerSaga, editDomainSaga, popupSagas].map(_regenerator2.default.mark);
	...
	function getTimer() {
	  var timer;
	  return _regenerator2.default.wrap(function getTimer$(_context2) {
	    while (1) {
	...
	function getTimerSaga() {
	  return _regenerator2.default.wrap(function getTimerSaga$(_context3) {
	    while (1) {
	      switch (_context3.prev = _context3.next) {
	        case 0:
	          return _context3.delegateYield((0, _reduxSaga.takeLatest)('GET_TIMER', getTimer), 't0', 1);
	...
	function editDomainSaga() {
	  return _regenerator2.default.wrap(function editDomainSaga$(_context4) {
	    while (1) {
	      switch (_context4.prev = _context4.next) {
	        case 0:
	          return _context4.delegateYield((0, _reduxSaga.takeLatest)('EDIT_DOMAIN_MODAL', editDomain), 't0', 1);
	...
	function popupSagas() {
	  return _regenerator2.default.wrap(function popupSagas$(_context5) {
	    while (1) {
	      switch (_context5.prev = _context5.next) {
	        ...
	        case 4:
	          _context5.next = 6;
	          return (0, _effects.fork)(editDomainSaga);
