	...
	var OptionsApp = function (_React$Component) {
	  ...
	  (0, _createClass3.default)(OptionsApp, [{
	    ...
	    value: function render() {
	      ...
	      if (this.props.sites) {
	        listOfPatterns = _react2.default.createElement(_SiteTable2.default, { sites: this.props.sites });
	      } else {
	        listOfPatterns = {};
	      }
...
/***/ function(module, exports, __webpack_require__) {
	...
	var SiteTable = function (_React$Component) {
	  ...
	  (0, _createClass3.default)(SiteTable, [{
	    key: 'sortSites',
	    value: function sortSites(sortBy) {
	      var sites = this.state.sites;
	      var sortedSites = sites.sort(function (a, b) {
	        return sites[a][sortBy] - sites[b][sortBy];
	      });
	      this.setState({
	        sites: sortedSites
	      });
	        ...
	        _react2.default.createElement(_fixedDataTable.Column, {
	          ...
	          cell: function cell(c) {
	            return _react2.default.createElement(
	              ...
	              null,
	              _this2.state.sites[c.rowIndex].site
	            );
	          },
	          fixed: 'true',
	          width: 200
	        ...
	        _react2.default.createElement(_fixedDataTable.Column, {
	          ...
	          cell: function cell(c) {
	            return _react2.default.createElement(
	              _fixedDataTable.Cell,
	              null,
	              _this2.state.sites[c.rowIndex].visits
	            );
	          },
	          width: 50
	        }),
